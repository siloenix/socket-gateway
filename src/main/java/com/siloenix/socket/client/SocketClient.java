...
import com.siloenix.socket.smp.SmpSerializer;
...
public class SocketClient {
    ...
    private final Queue<BaseMessage> queue = new LinkedList<>();
    ...
    public SocketClient queue(BaseMessage message) {
        queue.add(message);
        return this;
    }
    public SocketClient send(BaseMessage message) {
            ...
            clientBootstrap.handler(new ChannelInitializer<SocketChannel>() {
                protected void initChannel(SocketChannel socketChannel) {
                    socketChannel.pipeline().addLast(
                            new ClientMessageEncoder(new SmpSerializer()),
                            new ClientMessageDecoder(new SmpDeserializer()),
                            clientHandler
                    );
                }
            });
