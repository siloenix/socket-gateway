...
public class OpenAutomatonMessage extends Message {
    public static Integer FULL_LENGTH
            = 1 // size
            + 2 // command type
            + 2; // crc

    public OpenAutomatonMessage(byte[] body) {
        super(MessageType.OPEN_AUTOMATON, body);
    }

    public OpenAutomatonMessage() {
        super(MessageType.OPEN_AUTOMATON);
    }
